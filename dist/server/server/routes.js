...
import { translateRequestSchema, problemRequestSchema, createCheckoutSessionSchema, } from "../shared/schema.js";
// セッションベースの問題追跡（重複防止用）
...
export const handleEcho = (req, res) => {
...
export const handleGetUserSubscription = async (req, res) => {
    try {
        const authHeader = req.headers.authorization;
        let userId = "bizmowa.com";
        if (authHeader && authHeader.startsWith("Bearer ")) {
...
// Stripe関連
// ============================================================================
export const handleGetStripePrices = async (req, res) => {
    try {
...
export const handleGetSubscriptionPlans = (req, res) => {
    const currentMode = process.env.STRIPE_MODE || "test";
    const currentPrices = priceConfig[currentMode];
    const plans = {
        standard_monthly: {
...
export const handleStripePriceInfo = async (req, res) => {
    try {
...
export const handleSavePriceConfiguration = async (req, res) => {
    try {
...
export const handleGetSessionsByDifficulty = async (req, res) => {
    try {
...
// プログレス・統計
// ============================================================================
export const handleGetUserGoals = async (req, res) => {
    try {
...
export const handleUpdateUserGoals = async (req, res) => {
    try {
...
export const handleGetStreak = async (req, res) => {
    try {
...
export const handleGetDifficultyStats = async (req, res) => {
    try {
...
export const handleGetMonthlyStats = async (req, res) => {
    try {
...
// 復習・ブックマーク
// ============================================================================
export const handleGetReviewSessions = async (req, res) => {
    try {
...
export const handleGetRecentSessions = async (req, res) => {
    try {
...
export const handleGetBookmarkedSessions = async (req, res) => {
    try {
...
export const handleUpdateBookmark = async (req, res) => {
    try {
...
export const handleUpdateReviewCount = async (req, res) => {
    try {
        const sessionId = parseInt(req.params.id);
...
// カスタムシナリオ（プレミアム機能）
// ============================================================================
export const handleGetCustomScenarios = async (req, res) => {
    try {
...
export const handleCreateCustomScenario = async (req, res) => {
    try {
...
export const handleUpdateCustomScenario = async (req, res) => {
    try {
...
export const handleDeleteCustomScenario = async (req, res) => {
    try {
        const id = parseInt(req.params.id);
...
export const handleGetCustomScenario = async (req, res) => {
    try {
        const id = parseInt(req.params.id);
...
// シミュレーション機能（プレミアム）
// ============================================================================
export const handleGetSimulationProblem = async (req, res) => {
    try {
...
export const handleSimulationTranslate = async (req, res) => {
    try {
...
// 日次カウント管理
// ============================================================================
export const handleGetDailyCount = async (req, res) => {
    try {
...
export const handleResetDailyCount = async (req, res) => {
    try {
...
// その他のハンドラー
// ============================================================================
export const handleEmergencyReset = async (req, res) => {
    try {
...
export const handleCreateCustomerPortal = async (req, res) => {
    try {
        const stripeSecretKey = process.env.STRIPE_SECRET_KEY;
        if (!stripeSecretKey) {
            return res.status(500).json({ message: "Stripe not configured" });
...
export const handleGetSubscriptionDetails = async (req, res) => {
    try {
...
export const handleResetUserData = async (req, res) => {
    try {
...
export const handleGetAdminAnalytics = async (req, res) => {
    try {
        const userSubscription = await storage.getUserSubscription();
        if (!userSubscription?.isAdmin) {
            return res.status(403).json({ message: "管理者権限が必要です" });
...
export const handleAdminExport = async (req, res) => {
    try {
        const userSubscription = await storage.getUserSubscription();
        if (!userSubscription?.isAdmin) {
            return res.status(403).json({ message: "管理者権限が必要です" });
...
export const handleUpdateUserSubscription = async (req, res) => {
    try {
        const userSubscription = await storage.getUserSubscription();
        if (!userSubscription?.isAdmin) {
            return res.status(403).json({ message: "管理者権限が必要です" });
