    ...
    const handlePasswordReset = async () => {
        ...
        try {
            ...
            for (const { name, config } of configurations) {
                ...
                const { data, error } = await supabase_1.supabase.auth.resetPasswordForEmail(email, config);
      ...
      <card_1.Card className="w-full max-w-md">
        ...
        <card_1.CardContent>
          <form onSubmit={handleLogin} className="space-y-4">
            ...
            <div className="space-y-2">
              ...
              <div className="relative">
                ...
                <input_1.Input id="password" type={showPassword ? "text" : "password"} value={password} onChange={(e) => setPassword(e.target.value)} placeholder="パスワードを入力" className="pl-10 pr-10" required/>
          ...
          <div className="mt-2 text-center">
            <button_1.Button variant="link" className="text-sm text-gray-600 hover:text-gray-800" onClick={() => handlePasswordReset()}>
              パスワードをお忘れですか？
            </button_1.Button>
          </div>
          ...
          <div className="mt-4">
            ...
            <button_1.Button type="button" variant="outline" className="w-full mt-4" onClick={handleGoogleLogin}>
          ...
          <div className="mt-6 text-center text-sm">
            ...
            <button_1.Button variant="link" className="p-0 ml-1 h-auto" onClick={() => setLocation('/signup')}>
              新規登録
            </button_1.Button>
          </div>
        </card_1.CardContent>
