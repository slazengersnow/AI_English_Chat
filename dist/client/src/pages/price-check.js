...
exports.default = PriceCheck;
const react_1 = require("react");
const button_1 = require("@/components/ui/button");
const card_1 = require("@/components/ui/card");
const lucide_react_1 = require("lucide-react");
function PriceCheck() {
    const [priceData, setPriceData] = (0, react_1.useState)(null);
      ...
      <card_1.Card className="w-full max-w-4xl">
        ...
        <card_1.CardContent className="space-y-6">
          <div className="text-center">
            <button_1.Button onClick={checkPriceDetails} disabled={isLoading} className="w-full max-w-md">
              {isLoading ? "確認中..." : "価格設定を確認"}
            </button_1.Button>
          </div>

          {error && (<div className="bg-red-50 border border-red-200 rounded-lg p-4 flex items-start gap-3">
              <lucide_react_1.AlertCircle className="w-5 h-5 text-red-500 mt-0.5 flex-shrink-0"/>
              <div>
          ...
          {priceData && (<div className="space-y-4">
              ...
              <div className="bg-white border rounded-lg overflow-hidden">
                ...
                <div className="max-h-96 overflow-auto">
                  {priceData.prices.map((price, index) => (<div key={index} className="border-b last:border-b-0 p-4">
                      <div className="flex items-start justify-between">
                        <div className="flex-1">
                          <div className="flex items-center gap-2 mb-2">
                            ...
                            <span className={`text-xs px-2 py-1 rounded ${price.active ? 'bg-green-100 text-green-800' : 'bg-gray-100 text-gray-800'}`}>
                              {price.active ? '有効' : '無効'}
                            </span>
                          </div>
                          ...
                          {price.recurring && (<div className="text-sm text-gray-600 mt-1">
                        ...
                        <div className="text-right">
                          ...
                          {price.id === 'price_1ReXPnHridtc6DvMQaW7NC6w' && (<div className="text-xs bg-yellow-100 text-yellow-800 px-2 py-1 rounded mt-1">
                              使用中
                            </div>)}
                        </div>
                      </div>
