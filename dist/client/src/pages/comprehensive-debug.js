...
exports.default = ComprehensiveDebug;
...
function ComprehensiveDebug() {
    ...
    const [supabaseConfig, setSupabaseConfig] = (0, react_1.useState)(null);
    ...
    return (<div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100 flex items-center justify-center p-4">
      <card_1.Card className="w-full max-w-4xl">
        ...
        <card_1.CardContent className="space-y-6">
          {supabaseConfig && (<div className="bg-blue-50 p-4 rounded-lg">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <button_1.Button onClick={testSupabaseStatus} variant="outline" className="w-full">
              Supabaseステータステスト
            </button_1.Button>
          </div>

          {debugInfo && (<div className="space-y-2">
              <label_1.Label>詳細診断結果</label_1.Label>
