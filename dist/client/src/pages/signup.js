...
function Signup() {
    ...
    const [agreedToPrivacy, setAgreedToPrivacy] = (0, react_1.useState)(false);
      ...
      <card_1.Card className="w-full max-w-md">
        ...
        <card_1.CardContent>
          <form onSubmit={handleSignup} className="space-y-4">
            <div className="space-y-2">
              ...
              <div className="relative">
                ...
                <input_1.Input id="email" type="email" value={email} onChange={(e) => setEmail(e.target.value)} placeholder="example@email.com" className="pl-10" required/>
              </div>
            </div>
            
            <div className="space-y-2">
              <label_1.Label htmlFor="password">パスワード</label_1.Label>
              <div className="relative">
                <lucide_react_1.Lock className="absolute left-3 top-1/2 transform -translate-y-1/2 text-gray-400 w-4 h-4"/>
                <input_1.Input id="password" type={showPassword ? "text" : "password"} value={password} onChange={(e) => setPassword(e.target.value)} placeholder="最低8文字、英字と数字を含む" className="pl-10 pr-10" required/>
            ...
            <div className="space-y-3">
              <div className="flex items-center space-x-2">
                <checkbox_1.Checkbox id="terms" checked={agreedToTerms} onCheckedChange={(checked) => setAgreedToTerms(checked)}/>
              ...
              <div className="flex items-center space-x-2">
                <checkbox_1.Checkbox id="privacy" checked={agreedToPrivacy} onCheckedChange={(checked) => setAgreedToPrivacy(checked)}/>
                <label_1.Label htmlFor="privacy" className="text-sm">
          ...
          <div className="mt-4">
            ...
            <button_1.Button type="button" variant="outline" className="w-full mt-4" onClick={handleGoogleSignup}>
          ...
          <div className="mt-6 text-center text-sm">
            ...
            <button_1.Button variant="link" className="p-0 ml-1 h-auto" onClick={() => setLocation('/login')}>
              ログイン
            </button_1.Button>
          </div>
        </card_1.CardContent>
