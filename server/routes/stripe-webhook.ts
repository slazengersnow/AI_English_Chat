...
router.post(
  "/",
  express.raw({ type: "application/json" }), // ★ここが重要
...
async function handleSubscriptionCreated(subscription: Stripe.Subscription) {
  try {
    ...
    console.error(
      `❌ Error processing subscription creation ${subscription.id}:`,
      error,
    );
  }
}
...
async function handleSubscriptionUpdated(subscription: Stripe.Subscription) {
  try {
    ...
    console.error(
      `❌ Error processing subscription update ${subscription.id}:`,
      error,
    );
  }
}
...
async function handleSubscriptionDeleted(subscription: Stripe.Subscription) {
  try {
    ...
    console.error(
      `❌ Error processing subscription deletion ${subscription.id}:`,
      error,
    );
  }
}
