...
var databaseUrl = process.env.NODE_ENV === "production"
    ? process.env.DATABASE_URL
    : process.env.DATABASE_URL || process.env.DEV_DATABASE_URL;
if (!databaseUrl) {
    throw new Error("データベース接続URLが見つかりません。環境変数 DATABASE_URL または DEV_DATABASE_URL を設定してください。");
}
console.log("Using database URL:", (databaseUrl === null || databaseUrl === void 0 ? void 0 : databaseUrl.substring(0, 20)) + "...");
