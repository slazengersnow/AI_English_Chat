...
const difficultyPrompts: Record<string, { description: string, constraints: string, examples: string, temperature: number }> = {
  ...
  "business-email": {
    ...
    constraints: "15-30文字、敬語・丁寧語・謙譲語必須、幅広いビジネスシーンをカバー：【基本業務】挨拶・依頼・確認・報告・提案・案内・スケジュール・契約・顧客対応・社内外連絡・プレゼン・出張・人事関連 【キャンセル・返金】サービス解約・返金申請・キャンセルポリシー・部分返金・自動更新停止・データ保持・手数料・受付窓口・処理期間・計算方法 【カスタマーサポート】オンボーディング・パスワードリセット・価格交渉・在庫管理・情報漏洩対応・プロモーション・パートナーシップ・サービス復旧・レベル変更・ベータテスト・エスカレーション・請求書・製品リコール・レビュー・紹介・監査・データ削除・セキュリティ・API変更・多言語・配慮対応・一時停止・大口取引・休業案内など",
    examples: "お疲れさまです。 / 新しいプロジェクトについてご相談があります。 / キャンセルポリシーをお知らせします。 / 返金申請の手順をご案内します。 / オンボーディング資料をお送りします。 / セキュリティアップデートを実施します。 / データ削除のご依頼を承りました。 / 製品リコールの手続きをご案内します。 / 紹介プログラムにご招待します。 / API仕様変更のお知らせです。",
    temperature: 0.6
  },
  "simulation": {
