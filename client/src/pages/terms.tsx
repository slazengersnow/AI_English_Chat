          ...
          <CardContent className="space-y-6">
            <section>
              ...
              <p className="text-gray-700 leading-relaxed">
                本規約は、AI英作文チャット（以下「本サービス」）の利用に関して、本サービス運営者（以下「当社」）と本サービスを利用するユーザー（以下「ユーザー」）との間の権利義務関係を定めることを目的とし、ユーザーと当社との間で適用されます。
              </p>
            </section>
            ...
            <section>
              ...
              <p className="text-gray-700 leading-relaxed">
                ...
                2. ユーザーが利用料金の支払を遅滞した場合、当社は本サービスの提供を停止することができます。
              </p>
            </section>
