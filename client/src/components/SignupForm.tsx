...
interface SignupFormProps {
  onSignup: (email: string, password: string, confirmPassword: string, terms: boolean, privacy: boolean) => void;
  onGoogleSignup: () => void;
  onSwitchToLogin: () => void;
  loading?: boolean;
}

export function SignupForm({ onSignup, onGoogleSignup, onSwitchToLogin, loading = false }: SignupFormProps) {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    e.preventDefault();
    onSignup(email, password, confirmPassword, termsAccepted, privacyAccepted);
  };
