  ...
  useEffect(() => {
    ...
    const checkHash = () => {
      ...
      if (type === "recovery" && accessToken) {
        console.log(
          "HashHandler - Detected password recovery, redirecting to reset-password",
        );
        ...
        console.log(
          "HashHandler - Detected signup confirmation, processing authentication",
        );
              ...
              supabase.auth
                ...
                .then((result) => {
                  ...
                  if (result.error) {
                    ...
                    console.log(
                      "Session set successfully, redirecting to home",
                    );
                    setLocation("/");
                  }
                });
        ...
        console.log(
          "HashHandler - Detected access token, processing authentication",
        );
              ...
              supabase.auth
                ...
                .then((result) => {
                  ...
                  if (result.error) {
                    ...
                    console.log(
                      "General session set successfully, redirecting to home",
                    );
                    setLocation("/");
                  }
                });
